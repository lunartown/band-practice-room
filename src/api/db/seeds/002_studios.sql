...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '383' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-st-music' AND r.name='B Room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '382' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-st-music' AND r.name='A Room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '337' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='A1룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '338' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='A2룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '339' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='A3룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '340' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='B1룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '341' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='B2룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '342' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '343' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='D룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '344' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='E룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '175' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-본점' AND r.name='S룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '191' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-합정1호점' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '192' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-합정1호점' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '193' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-합정1호점' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '194' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-합정1호점' AND r.name='Jazz룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '190' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-그라운드-합정1호점' AND r.name='S룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '246' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-디엠' AND r.name='2번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '245' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-디엠' AND r.name='1번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '377' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-라라' AND r.name='V룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '376' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-라라' AND r.name='R룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '356' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-별나무' AND r.name='R룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '357' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-별나무' AND r.name='Y룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '358' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-별나무' AND r.name='T룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '359' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-별나무' AND r.name='J룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '355' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-별나무' AND r.name='V룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '370' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-불리스튜디오' AND r.name='NIGHTMARE';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '369' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-불리스튜디오' AND r.name='HELL';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '361' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-브라운' AND r.name='그린룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '362' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-브라운' AND r.name='옐로우룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '363' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-브라운' AND r.name='그레이룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '360' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-브라운' AND r.name='브라운룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '196' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티' AND r.name='Room A';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '197' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티' AND r.name='Room B';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '198' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티' AND r.name='Room C';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '199' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티' AND r.name='Room D';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '200' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티' AND r.name='Room E';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '195' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티' AND r.name='Live Room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '254' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티-홍대점' AND r.name='Room 2';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '255' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티-홍대점' AND r.name='Room 3';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '256' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티-홍대점' AND r.name='Room 4';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '257' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티-홍대점' AND r.name='Room 5';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '253' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-사운드시티-홍대점' AND r.name='Room 1';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '371' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-스팟사운드' AND r.name='호랑이1';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '366' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-앨리' AND r.name='부스2';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '367' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-앨리' AND r.name='부스3';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '368' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-앨리' AND r.name='부스4';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '365' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-앨리' AND r.name='부스1';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '213' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-에비로드' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '214' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-에비로드' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '212' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-에비로드' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '202' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-오렌지' AND r.name='2번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '203' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-오렌지' AND r.name='3번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '204' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-오렌지' AND r.name='4번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '201' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-오렌지' AND r.name='개러지룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '353' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-웨이브랩' AND r.name='R2룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '354' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-웨이브랩' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '352' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-웨이브랩' AND r.name='R1룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '379' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-웨이브랩2호점' AND r.name='Back In Black';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '380' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-웨이브랩2호점' AND r.name='Kind Of Blue';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '381' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-웨이브랩2호점' AND r.name='After School Tea Time';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '378' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-웨이브랩2호점' AND r.name='White Room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '375' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-이막' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '374' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-이막' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '173' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-제시뮤직' AND r.name='합주실 A';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '174' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-제시뮤직' AND r.name='합주실 B';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '172' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-제시뮤직' AND r.name='합주실 R';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '528' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-제시뮤직합정점' AND r.name='합주실 달';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '529' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-제시뮤직합정점' AND r.name='합주실 별';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '527' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-제시뮤직합정점' AND r.name='합주실 해';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '373' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-차마스튜디오' AND r.name='BURGUNDY';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '372' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-차마스튜디오' AND r.name='Black';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '346' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-하모닉스1호점' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '347' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-하모닉스1호점' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '345' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-하모닉스1호점' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '216' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-하모닉스2호점' AND r.name='BLUE ROOM';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '348' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-하모닉스2호점' AND r.name='J ROOM';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '218' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-하모닉스2호점' AND r.name='MINI ROOM';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '215' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-하모닉스2호점' AND r.name='RED ROOM';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '350' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-호랑이' AND r.name='호랑이2';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '351' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-호랑이' AND r.name='호랑이3';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '349' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-호랑이' AND r.name='호랑이1';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '364' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-합정/홍대-홍대리엠뮤직' AND r.name='합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '185' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-그라운드-신촌' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '186' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-그라운드-신촌' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '187' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-그라운드-신촌' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '184' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-그라운드-신촌' AND r.name='S룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '385' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-드림' AND r.name='본점 A';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '386' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-드림' AND r.name='본점 B';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '387' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-드림' AND r.name='본점 C';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '388' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-드림' AND r.name='연대점 R';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '389' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-드림' AND r.name='연대점 Q';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '390' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-드림' AND r.name='연대점 F';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '384' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-드림' AND r.name='본점 V';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '260' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-라디오가가' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '261' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-라디오가가' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '262' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-라디오가가' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '263' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-라디오가가' AND r.name='D룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '259' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-라디오가가' AND r.name='S룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '189' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-신촌-그라운드' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '188' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신촌-신촌-그라운드' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '431' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-그루브-사당점' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '432' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-그루브-사당점' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '433' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-그루브-사당점' AND r.name='D룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '430' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-그루브-사당점' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '395' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당1호점' AND r.name='사당1호점 S';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '396' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당1호점' AND r.name='사당1호점 Q';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '397' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당1호점' AND r.name='사당1호점 C';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '398' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당1호점' AND r.name='사당1호점 D';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '394' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당1호점' AND r.name='사당1호점 V';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '400' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당2호점' AND r.name='사당2호점 2번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '401' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당2호점' AND r.name='사당2호점 3번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '402' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당2호점' AND r.name='사당2호점 4번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '399' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-드림-사당2호점' AND r.name='사당2호점 1번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '525' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-sadang_isu-드림-사당점' AND r.name='사당점 C';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '526' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-sadang_isu-드림-사당점' AND r.name='사당점 D';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '524' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-sadang_isu-드림-사당점' AND r.name='사당점 Q';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '523' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-sadang_isu-드림-사당점' AND r.name='사당점 S';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '522' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-sadang_isu-드림-사당점' AND r.name='사당점 V';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '223' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-비쥬1호점' AND r.name='화이트룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '222' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-비쥬1호점' AND r.name='블랙룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '225' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-비쥬2호점' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '224' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-비쥬2호점' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '392' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-비쥬3호점' AND r.name='M룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '393' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-비쥬3호점' AND r.name='J룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '391' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-비쥬3호점' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '404' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-사운딕트' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '405' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-사운딕트' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '403' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-사운딕트' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '534' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-사운딕트2호점' AND r.name='A ROOM';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '535' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-사운딕트2호점' AND r.name='B ROOM';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '533' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-사운딕트2호점' AND r.name='S ROOM';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '239' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-에이타입사운드' AND r.name='라운지';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '238' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-에이타입사운드' AND r.name='스테이지';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '407' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-위드뮤직' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '406' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-위드뮤직' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '408' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-사당/이수-톤' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '439' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신도림/영등포구청-겟밴드-아지트' AND r.name='겟밴드아지트';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '511' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신도림/영등포구청-겟밴드-아지트' AND r.name='기본룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '434' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신도림/영등포구청-뮤지트' AND r.name='합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '436' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신도림/영등포구청-일상' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '437' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신도림/영등포구청-일상' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '438' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신도림/영등포구청-일상' AND r.name='D룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '435' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-신도림/영등포구청-일상' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '295' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-mangwon-3YL리허설' AND r.name='ROOM 1';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '296' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-mangwon-3YL리허설' AND r.name='ROOM 2';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '294' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-mangwon-알엠스튜디오' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '281' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-상도,중앙대-스페이스개러지-중앙대점' AND r.name='Room R';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '282' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-상도,중앙대-스페이스개러지-중앙대점' AND r.name='Room X';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '280' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-상도,중앙대-스페이스개러지-중앙대점' AND r.name='Room L';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '440' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-상도,중앙대-위드제이' AND r.name='합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '276' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-상도,중앙대-준사운드' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '277' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-상도,중앙대-준사운드' AND r.name='S룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '275' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-상도,중앙대-준사운드' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '445' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-서울대입구-DOH음악스튜디오' AND r.name='라운지합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '443' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-서울대입구-길드합주실' AND r.name='유니크룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '444' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-서울대입구-길드합주실' AND r.name='레어룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '442' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-서울대입구-길드합주실' AND r.name='에픽룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '441' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-서울대입구-모노합주실' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '292' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-서울대입구-브이엔앰스토리' AND r.name='Garage Music Studio 1';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '447' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-그루브-방배점' AND r.name='2번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '448' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-그루브-방배점' AND r.name='3번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '449' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-그루브-방배점' AND r.name='4번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '450' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-그루브-방배점' AND r.name='5번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '446' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-그루브-방배점' AND r.name='1번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '412' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-보고스튜디오' AND r.name='보고합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '230' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-비쥬-방배점' AND r.name='2번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '231' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-비쥬-방배점' AND r.name='3번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '232' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-비쥬-방배점' AND r.name='4번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '409' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-비쥬-방배점' AND r.name='5번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '410' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-비쥬-방배점' AND r.name='6번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '411' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-비쥬-방배점' AND r.name='7번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '229' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-방배-비쥬-방배점' AND r.name='1번룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '452' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-대학로점' AND r.name='대학로 1호점 B';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '453' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-대학로점' AND r.name='대학로 1호점 C';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '454' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-대학로점' AND r.name='대학로 2호점 S';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '455' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-대학로점' AND r.name='대학로 2호점 R';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '451' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-대학로점' AND r.name='대학로 1호점 A';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '457' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-마로니에점' AND r.name='마로니에 3호점 G';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '458' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-마로니에점' AND r.name='마로니에 3호점 O';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '459' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-마로니에점' AND r.name='마로니에 3호점 D';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '456' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-드림-마로니에점' AND r.name='마로니에 3호점 J';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '269' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-hyehwa_sungshin-룸디' AND r.name='Rehearsal Room A (심야)';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '268' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-hyehwa_sungshin-룸디' AND r.name='Rehearsal Room A (주/야간)';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '271' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-hyehwa_sungshin-룸디' AND r.name='Rehearsal Room B (심야)';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '270' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-hyehwa_sungshin-룸디' AND r.name='Rehearsal Room B (주/야간)';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '461' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-성북천-음악소' AND r.name='1번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '460' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-세탁소아랫집' AND r.name='스튜디오';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '273' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-스페이스개러지-성신여대점' AND r.name='Room R';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '274' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-스페이스개러지-성신여대점' AND r.name='Room X';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '272' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-스페이스개러지-성신여대점' AND r.name='Room L';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '462' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-혜화/성신여대-영사운드' AND r.name='영사운드합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '417' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-레드스튜디오' AND r.name='합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '413' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-리엠뮤직-강남' AND r.name='리엠뮤직합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '464' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-엠플사운드' AND r.name='A2룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '465' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-엠플사운드' AND r.name='B1룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '466' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-엠플사운드' AND r.name='B2룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '467' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-엠플사운드' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '463' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-엠플사운드' AND r.name='A1룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '415' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-파워하우스' AND r.name='Studio B';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '416' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-파워하우스' AND r.name='Studio C';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '414' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강남-파워하우스' AND r.name='Studio A';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '418' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-리엠뮤직-잠실' AND r.name='리엠뮤직합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '512' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-리튬' AND r.name='Main Room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '419' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-리튬' AND r.name='메인룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '299' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-강동' AND r.name='2번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '300' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-강동' AND r.name='5번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '301' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-강동' AND r.name='3번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '302' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-강동' AND r.name='4번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '298' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-강동' AND r.name='1번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '304' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-송파' AND r.name='2번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '305' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-송파' AND r.name='3번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '306' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-송파' AND r.name='4번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '468' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-송파' AND r.name='라이브홀';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '303' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-브라더-송파' AND r.name='1번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '420' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-스페이스블루' AND r.name='대양홀';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '308' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-아지트' AND r.name='S room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '309' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-아지트' AND r.name='A room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '310' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-아지트' AND r.name='B room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '307' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-강동/송파-아지트' AND r.name='R room';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '330' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-gangdong_songpa-호세네아지트' AND r.name='기본룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '481' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그래비티' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '482' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그래비티' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '480' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그래비티' AND r.name='A룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '470' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그루브-노원점' AND r.name='2번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '471' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그루브-노원점' AND r.name='3번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '472' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그루브-노원점' AND r.name='4번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '473' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그루브-노원점' AND r.name='5번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '469' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그루브-노원점' AND r.name='1번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '425' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-그루브합주실' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '422' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-리엠뮤직-건대' AND r.name='2번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '421' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-리엠뮤직-건대' AND r.name='1번방';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '424' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-리엠뮤직-금호' AND r.name='리엠뮤직합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '423' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-리엠뮤직-숙대입구' AND r.name='리엠뮤직합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '429' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-소리모아' AND r.name='합주실';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '474' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-죠니의-리빙룸' AND r.name='죠니의 리빙룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '427' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-한스' AND r.name='B룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '428' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-한스' AND r.name='C룸';
...
INSERT INTO room_sources (room_id, source_id, external_key) SELECT r.id, 1, '426' FROM rooms r JOIN studios s ON r.studio_id=s.id WHERE s.slug='studio-기타-서울-한스' AND r.name='A룸';
